      ...
      for (const pen of metrics.pens) {
        ...
        for (const iv of pen.intervals) {
          ...
          rows.push({
            ...
            economic_fcr: iv.offeredPerKgGain != null ? out(iv.offeredPerKgGain, 2) : "",
            biological_fcr: iv.eatenPerKgGain != null ? out(iv.eatenPerKgGain, 2) : usable ? incompleteLabel(iv.leftoverDays, iv.feedingDays) : "",
            biological_fcr_dry_matter: iv.dmMissing ? "add dry-matter % in Setup" : iv.eatenDmPerKgGain != null ? out(iv.eatenDmPerKgGain, 2) : usable ? incompleteLabel(iv.leftoverDays, iv.feedingDays) : "",
            ...
            growth_per_snail_per_day_g: out(iv.growthPerSnailPerDay_g, 2),
            pen_gain_per_day_g: out(iv.gainPerDay_g, 1),
            feed_offered_per_day_g: out(iv.offeredPerDay_g, 1),
            feed_eaten_per_day_g: iv.leftoverDays > 0 ? out(iv.eatenPerDay_g, 1) : "",
            sgr_percent_body_weight_per_day: out(iv.sgr, 2),
